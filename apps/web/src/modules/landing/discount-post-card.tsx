...
export function DiscountPostCard({ post, index }: DiscountPostCardProps) {
  ...
  return (
    <div
      className="group relative bg-white rounded-xl border border-gray-200 hover:border-[#D4AF37]/50 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden animate-in fade-in slide-in-from-bottom-4"
      style={{
    ...
    >
      ...
      <div className="p-4 space-y-2">
        {/* Title */}
        <h3 className="text-sm font-bold text-[#0F172A] line-clamp-2 group-hover:text-[#D4AF37] transition-colors duration-300 min-h-[2.5rem]">
          {post.postTitle}
        </h3>
