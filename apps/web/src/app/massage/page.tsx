...
export default function MassagePage() {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-900 min-h-screen">
      ...
      <section
        className="py-20 bg-gray-50 dark:bg-gray-800/20 border-t border-gray-100 dark:border-gray-800"
        id="calendar"
      >
                  ...
                  <div className="grid gap-8 text-gray-700 dark:text-gray-300">
                      ...
                      <div className="space-y-4 ml-8">
                        <div>
                          ...
                          <ul className="space-y-2 text-sm list-disc pl-4">
                            <li>
                              Termine können ausschließlich telefonisch
                              vereinbart werden.
                            </li>
                            <li>Online-Buchungen sind nicht möglich.</li>
                            <li>
                              Termine können frühestens 1-2 Tage im Voraus
                              gebucht werden.
                            </li>
                          </ul>
                        </div>
                        ...
                        <div>
                          ...
                          <ul className="space-y-2 text-sm list-disc pl-4">
                            <li>
                              ...
                              innerhalb von 24h leisten.
                            </li>
                            <li>
                              Zahlungsnachweis (z.B. Überweisungsbeleg) per
                              WhatsApp oder SMS übermitteln.
                            </li>
                            <li>
                              Termin gilt erst nach Eingang der Anzahlung als
                              verbindlich.
                            </li>
                          </ul>
                        </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4 ml-8">
                        <div>
                          ...
                          <ul className="space-y-2 text-sm list-disc pl-4">
                            <li>
                              Kostenfrei bis 24h vorher (bei Buchung {">"} 2
                              Tage im Voraus).
                            </li>
                            <li>
                              Kostenfrei bis 6h vorher (bei Buchung 1 Tag im
                              Voraus).
                            </li>
                            <li>
                              Bei späteren Stornierungen oder No-Show wird die
                        ...
                        <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-xl border border-amber-100 dark:border-amber-900/30">
                          ...
                          <p className="text-sm text-amber-900/80 dark:text-amber-300/80">
                            Bitte 10 Min. früher erscheinen (Anamnese). Bei
                            Verspätung verkürzt sich die Zeit, der volle Preis
                            bleibt fällig.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                      ...
                      <p className="mt-6 text-center text-xs text-gray-400 leading-relaxed italic">
                        Mit der telefonischen Buchung erklärst du dich mit
                        diesen Buchungs- & Stornierungsbedingungen
                        einverstanden. Bei Fragen kontaktieren Sie uns bitte
                        vorab.
                      </p>
                    </div>
                  </div>
