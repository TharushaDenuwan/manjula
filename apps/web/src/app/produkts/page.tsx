...
export default async function ProduktsPage() {
  ...
  return (
    <div className="w-full bg-white min-h-screen">
      {/* Hero Section */}
      <section className="relative w-full min-h-[40vh] md:min-h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-amber-100 via-amber-50 to-stone-100">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-gray-700">
              Entdecken Sie unsere sorgfältig ausgewählten ayurvedischen Produkte für Ihr Wohlbefinden
            </p>
          </div>
        </div>
      </section>
