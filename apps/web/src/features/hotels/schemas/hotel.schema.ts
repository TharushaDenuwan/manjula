...
import { roomTypeSchema } from "./rooms.schema";
...
export type HotelImageUpdateType = z.infer<typeof hotelImageUpdateSchema>;
...
export const hotelInsertByAdminSchema = createInsertSchema(hotels).omit({
  id: true,
  createdAt: true,
  updatedAt: true
});
